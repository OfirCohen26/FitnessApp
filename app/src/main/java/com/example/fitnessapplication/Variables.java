...
public interface Variables {
    ...
    final String [] PLAN_C= {"Tabata 1 -  Burpees","Tabata 2 -  Mountain Climbers","Tabata 3 - Jump Squat", "Tabata 4 - Plank Jacks",
            "Tabata 5 -  Spiderman Plank",", This workout is a form of high intensity interval training designed to get your heart rate up in that very hard anaerobic zone for short periods of time.", ", Each exercise - 8 Rounds – 20 seconds on 10 seconds off"};
}
